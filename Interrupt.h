...
typedef enum
{
    ...
    Timer5_subtimerA = 92,
    Timer5_SubtimerB,
    WideTimer0_SubtimerA,
    WideTimer0_SubtimerB,
    WideTimer1_SubtimerA,
    WideTimer1_SubtimerB,
    WideTimer2_SubtimerA,
    WideTimer2_SubtimerB,
    WideTimer3_SubtimerA,
    WideTimer3_SubtimerB,
    WideTimer4_SubtimerA,
    WideTimer4_SubtimerB,
    WideTimer5_SubtimerA,
    WideTimer5_SubtimerB,
    FPU,
    PWM1Generator_0 = 134,
    PWM1Generator_1,
    PWM1Generator_2,
